...
const RelationCardForm = ({ relations, setForm }: Props) => {
  ...
  return (
    <Card className="grid grid-flow-row grid-cols-1 md:grid-cols-2 gap-2">
      <InputContainer name={t("character.relations_close")}>
        <input
      ...
      <InputContainer name={t("character.relations_opposite")}>
        <input
      ...
      <InputContainer name={t("character.relations_distant")}>
        <input
      ...
      <InputContainer name={t("character.relations_enemy")}>
        <input
