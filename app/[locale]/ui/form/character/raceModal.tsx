...
const RaceModal = ({ charRace, primeBlood, races, setForm }: Props) => {
  ...
  const InputContainer = ({
    ...
    <div className="flex items-baseline justify-center">
      <label className={clsx("mb-3 mt-5 block text-xs font-medium", className)}>
        {name} : &nbsp;
      </label>
                  ...
                  {primaryRace && (
                    <>
                      ...
                      <div className="h-full w-[40%]">
                            ...
                            {primaryRace.bonus
                              ...
                              .map((bonus) => (
                                ...
                                >
                                  ...
                                  />
                                  <label>{t(`stat.${bonus}`)}</label>
                                </div>
                              ))}
                          </div>
                          <div className="grow">{t("common.capital_and")}</div>
                        ...
                        <div className="mx-[15%] font-bold mt-4 text-left mb-1">
                          {t("technique_spell.passive")}
                        </div>
                        <div className="mx-[15%] font-bold mt-4 text-left mb-1">
                          {t("technique_spell.active")}
                        </div>
                      </div>
                    </>
                  )}
